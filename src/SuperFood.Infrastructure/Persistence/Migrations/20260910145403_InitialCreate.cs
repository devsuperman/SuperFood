        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    dine_in_enabled = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_restaurant_operating_hours", x => x.id);
                    table.ForeignKey(
                        name: "fk_restaurant_operating_hours_restaurants_restaurant_id",
                        column: x => x.restaurant_id,
                        principalTable: "restaurants",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "fk_roles_restaurants_restaurant_id",
                        column: x => x.restaurant_id,
                        principalTable: "restaurants",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    qr_code_token = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false),
                    status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    delivery_customer_name = table.Column<string>(type: "character varying(150)", maxLength: 150, nullable: true),
                    delivery_address = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: true),
                    delivery_contact_phone = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    customer_session_id = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    variation_price_adjustment = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "ix_asp_net_users_restaurant_id",
                table: "AspNetUsers",
            ...
            migrationBuilder.CreateIndex(
                name: "ix_order_items_restaurant_id",
                table: "order_items",
                column: "restaurant_id");

            migrationBuilder.CreateIndex(
                name: "ix_orders_customer_session_id",
                table: "orders",
                column: "customer_session_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_product_variations_restaurant_id",
                table: "product_variations",
                column: "restaurant_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_products_restaurant_id",
                table: "products",
                column: "restaurant_id");
            ...
            migrationBuilder.CreateIndex(
                name: "ix_restaurant_operating_hours_restaurant_id_day_of_week",
                table: "restaurant_operating_hours",
                columns: new[] { "restaurant_id", "day_of_week" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_roles_restaurant_id",
                table: "roles",
                column: "restaurant_id");

            migrationBuilder.CreateIndex(
                name: "ix_table_sessions_restaurant_id",
